...
private:
	[[nodiscard]] static GLuint createDepthTexture(int width, int height)
	{
		...
		// Note that you should probably use different filtering parameters for uDepthBuffer
		// and uShadowSampler. Otherwise, there are small visual artefacts that I call
		// "shadow seams" created by the interpolated (GL_LINEAR) blocker search.
